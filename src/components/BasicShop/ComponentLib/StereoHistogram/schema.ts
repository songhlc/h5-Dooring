import { NumberDefaultType, TextDefaultType } from '@/core/FormComponents/types';
import {
  baseConfig,
  BaseConfigType,
  baseDefault,
...
export type StereoHistogramEditDataType = Array<BaseConfigType | BaseDataConfigType>;
...
const StereoHistogram: StereoHistogramSchema = {
  editData: [...baseConfig, ...getBaseDataConfig()],
  config: {
    ...baseDefault,
    ...baseDataDefault,
    width: 500,
