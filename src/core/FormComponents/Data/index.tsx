...
const Data: React.FC<DataProps> = memo(
  forwardRef(({ value = '', onChange }, _ref) => {
    ...
    return (
      <React.Fragment>
        <Button ghost type="primary" size="small" onClick={toggloVisible}>
        ...
        >
          <AceEditor
            value={JSON.stringify(value && isString(value) ? JSON.parse(value) : value, null, 2)}
